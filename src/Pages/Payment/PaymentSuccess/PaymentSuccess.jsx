...
import paySuccess from "../../../assets/PaymentSuccess.mp4";
...
const PaymentSuccess = () => {
  ...
  const setSessonId = searchParams.get("session_id");
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="w-64 h-64 overflow-hidden rounded-full border-4 border-green-400 shadow-md">
          <video
            ...
            playsInline
          >
            <source src={paySuccess} type="video/mp4" />
        ...
        <h2 className="mt-6 text-3xl font-bold text-green-600 flex items-center gap-3">
          Payment Successful <PartyPopper size={45}></PartyPopper>
        </h2>
